...
type HelpKey = 'rsi' | 'macd' | 'bb' | 'sma' | 'atr' | 'stoch' | 'signals';
    ...
    content: (
      <>
        <HelpSection title="¿Qué muestra?">
          <p>Consolida las señales de los principales indicadores técnicos en una vista rápida. Cada indicador emite una señal individual y el sistema genera un veredicto global.</p>
        </HelpSection>
        <HelpSection title="Señales posibles">
          <p><strong style={{ color: 'var(--positive)' }}>Bullish / Oversold</strong>: el indicador sugiere momentum alcista o activo sobrevendido (posible rebote).<br />
          <strong style={{ color: 'var(--negative)' }}>Bearish / Overbought</strong>: el indicador sugiere momentum bajista o activo sobrecomprado (posible corrección).<br />
          <strong style={{ color: 'var(--text-muted)' }}>Neutral</strong>: el indicador no da una señal clara en ninguna dirección.</p>
        </HelpSection>
        <HelpSection title="Señal global">
          <p>Se determina por mayoría: si la mayoría de señales son alcistas, la señal global es bullish, y viceversa. Es una guía de referencia; siempre confirmá con el análisis de cada indicador.</p>
        </HelpSection>
      </>
    ),
  },
  ...
  return (
    <>
      ...
      <div className="page-body">
        ...
        {signals && (
          <Card title="Resumen de señales" style={{ marginBottom: 'var(--sp-5)' }} onHelp={() => setOpenHelp('signals')}>
